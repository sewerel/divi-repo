<?php
/**
 * Module Library: FullwidthMenu Module Preset Attributes Map
 *
 * @package Divi
 * @since ??
 */
...
/**
 * Class FullwidthMenuPresetAttrsMap
 *
 * @since ??
 *
 * @package ET\Builder\Packages\ModuleLibrary\FullwidthMenu
 */
class FullwidthMenuPresetAttrsMap {
	/**
	 * Get the preset attributes map for the FullwidthMenu module.
	 *
	 * @since ??
	 *
	...
	public static function get_map( array $map, string $module_name ) {
		if ( 'divi/fullwidth-menu' !== $module_name ) {
			return $map;
		}
